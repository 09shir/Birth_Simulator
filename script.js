...
function nextBirth(){
    let country = result();
    document.getElementById('displayCountry').innerHTML = "You were born in: " + country;
...
function getPopulation(populations, country){
...
function result(){
    ...
    for (let i = 0; i < countries2.length; i++){
        ...
        tmp += getPopulation(populations, tmpName) * countries2[i].birth_rate;
        if (num <= tmp){
